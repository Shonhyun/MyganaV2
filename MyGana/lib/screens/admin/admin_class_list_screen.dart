            ...
            itemBuilder: (context, index) {
              ...
              return Container(
                ...
                child: ListTile(
                  ...
                  title: Text(c.nameSection, maxLines: 1, overflow: TextOverflow.ellipsis,
                  ...
                  subtitle: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(c.yearRange, maxLines: 1, overflow: TextOverflow.ellipsis,
                              style: TextStyle(color: Colors.grey[700])),
                        ),
                        const SizedBox(width: 8),
                        Icon(Icons.qr_code_2, size: 14, color: Colors.grey[600]),
                        const SizedBox(width: 2),
                        Text(c.classCode, style: TextStyle(color: Colors.grey[700])),
                      ],
                    ),
                  ),
                  ...
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => AdminClassStudentsScreen(classId: c.classId, title: c.nameSection),
                    ),
                  ),
                ),
              );
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                try {
                  final info = await _service.createClass(
                  ...
                  if (mounted) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text('Class created. Code: ${info.classCode}')),
                    );
                  }
                } catch (e) {
                  if (mounted) {
