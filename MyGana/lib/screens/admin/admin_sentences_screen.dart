            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (value) => value == null || value.isEmpty ? 'English translation is required' : null,
                ),
                const SizedBox(height: 12),
                TextFormField(
                  controller: _japaneseController,
                  decoration: InputDecoration(
                    labelText: _isCharacterLesson() ? 'Japanese Character/Phrase' : 'Japanese Sentence',
                  ...
                  validator: (value) => value == null || value.isEmpty ? 'Japanese text is required' : null,
                ),
                const SizedBox(height: 12),
                TextFormField(
                  ...
                  validator: (value) => value == null || value.isEmpty ? 'Romaji is required' : null,
                ),
                const SizedBox(height: 16),
                Row(
                        ...
                        if (_sentenceFormKey.currentState!.validate()) {
                          ...
                          try {
                            ...
                            if (mounted) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text('${_isCharacterLesson() ? 'Character/Phrase' : 'Sentence'} successfully created.'),
                            ...
                            if (mounted) {
                              String errorMessage = 'Failed to create ${_isCharacterLesson() ? 'character/phrase' : 'sentence'}: $e';
                        ...
                        if (_editSentenceFormKey.currentState!.validate()) {
                          ...
                          try {
                            ...
                            if (mounted) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text('${_isCharacterLesson() ? 'Character/Phrase' : 'Sentence'} successfully updated.'),
                                  backgroundColor: Colors.green[700],
                                  behavior: SnackBarBehavior.floating,
                                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
                                ),
                            ...
                            if (mounted) {
                              String errorMessage = 'Failed to update ${_isCharacterLesson() ? 'character/phrase' : 'sentence'}: $e';
                              if (e.toString().contains('permission_denied')) {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              Text('Are you sure you want to delete this ${_isCharacterLesson() ? 'character/phrase' : 'sentence'}? This action cannot be undone.'),
              const SizedBox(height: 16),
              Row(
                mainAxisAlignment: MainAxisAlignment.end,
                children: [
    ...
    if (shouldDelete == true) {
      try {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('${_isCharacterLesson() ? 'Character/Phrase' : 'Sentence'} successfully deleted.'),
              backgroundColor: Colors.green[700],
              behavior: SnackBarBehavior.floating,
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
            ),
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('Failed to delete ${_isCharacterLesson() ? 'character/phrase' : 'sentence'}: $e'),
              backgroundColor: Colors.red[700],
              behavior: SnackBarBehavior.floating,
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
            ),
                            ...
                            Row(
                              children: [
                                ...
                                IconButton(
                                  ...
                                  tooltip: 'Edit',
                                  onPressed: () => _showModifySentenceDialog(sentence['id'], sentence),
                                ),
                                IconButton(
