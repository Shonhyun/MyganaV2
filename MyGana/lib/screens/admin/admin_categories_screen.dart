            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (value) => value == null || value.isEmpty ? 'Category name is required' : null,
                ),
                const SizedBox(height: 16),
                Row(
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        if (_categoryFormKey.currentState!.validate()) {
                          try {
                            debugPrint('Attempting to create category: ${_categoryController.text.trim()}');
                            
                            // Verify admin status again before writing
                            bool isStillAdmin = await _authService.isAdmin();
                            if (!isStillAdmin) {
                              throw Exception('Admin privileges lost. Please refresh and try again.');
                            }
                            ...
                            debugPrint('Category created successfully at: categories/${widget.level.toLowerCase()}/$categoryKey');
                            ...
                            if (mounted) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text('Category successfully created with $lessonCount lessons.'),
                                  backgroundColor: Colors.green[700],
                                  behavior: SnackBarBehavior.floating,
                                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
                                ),
                            ...
                            if (mounted) {
                              ...
                              if (e.toString().contains('permission_denied') || e.toString().contains('Permission denied')) {
                                errorMessage = 'Permission denied. Please ensure you have admin privileges and try again.';
                              }
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
  ...
  Future<void> _deleteCategory(String categoryKey, String categoryName) async {
    final shouldDelete = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('Are you sure you want to delete "$categoryName"? This will also delete all lessons in this category.'),
        actions: [
          TextButton(
                                  ...
                                  children: [
                                    ...
                                    FutureBuilder<int>(
                                      ...
                                      builder: (context, countSnapshot) {
                                        final actualCount = countSnapshot.data ?? category['lesson_count'];
                                        return Text(
