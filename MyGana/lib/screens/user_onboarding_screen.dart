...
class _UserOnboardingScreenState extends State<UserOnboardingScreen>
  ...
  void initState() {
    ...
    debugPrint('UserOnboardingScreen init: email=${widget.email}, user=${_authService.currentUser?.uid}');
  }
  ...
  Future<void> _saveUserData() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        debugPrint('Saving user data: email=${widget.email}, currentUser=${_authService.currentUser?.uid}');
